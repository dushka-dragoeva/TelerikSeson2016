...
namespace CohesionAndCoupling
{
    internal class Paralelepiped
    {
        ...
        {
            double distance = GeometricUtils.CalcDistance3D(0, 0, 0, this.Width, this.Height, this.Depth);
            return distance;
        }

        public double CalcDiagonalXY()
        {
            double distance = GeometricUtils.CalcDistance2D(0, 0, this.Width, this.Height);
            return distance;
        }

        public double CalcDiagonalXZ()
        {
            double distance = GeometricUtils.CalcDistance2D(0, 0, this.Width, this.Depth);
            return distance;
        }

        public double CalcDiagonalYZ()
        {
            double distance = GeometricUtils.CalcDistance2D(0, 0, this.Height, this.Depth);
            return distance;
        }
    }
}
