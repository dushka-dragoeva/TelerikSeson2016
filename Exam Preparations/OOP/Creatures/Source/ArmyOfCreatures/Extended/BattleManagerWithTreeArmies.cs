namespace ArmyOfCreatures.Extended
{
    ...
    public class BattleManagerWithTreeArmies : BattleManager, IBattleManager
    {
        private readonly ICollection<ICreaturesInBattle> thirdArmyCreatures;

        public BattleManagerWithTreeArmies(ICreaturesFactory creaturesFactory, ILogger logger) :
