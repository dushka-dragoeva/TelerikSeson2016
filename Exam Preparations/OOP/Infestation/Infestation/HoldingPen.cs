    ...
    public class HoldingPen
    {
        ...
        protected virtual void ExecuteInsertUnitCommand(string[] commandWords)
        {
            switch (commandWords[1])
            {
                ...
                case "Marine":
                    var marin = new Human(commandWords[2]);
                    this.InsertUnit(marin);
                    break;

                case "Tank":
                    var tank = new Human(commandWords[2]);
        ...
        protected virtual void ExecuteAddSupplementCommand(string[] commandWords)
        {
            switch (commandWords[1])
            {
                ...
                case "Weapon":
                    ...
                    this.InsertSupplyment(weapon, commandWords[2]);

                    break;
                case "Catalists":
                    var catalist = new Catalists();
                    this.InsertSupplyment(catalist, commandWords[2]);
                    break;
                default:
                    break;
            }
